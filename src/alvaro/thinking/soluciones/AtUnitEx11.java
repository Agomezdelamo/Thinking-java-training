// net.mindview.atunit.AtUnit11.java
// TIJ4 Chapter Annotations, Exercise 11, page 1104
...
* // annotations.TestNoteEx11.java
* package annotations;
* import net.mindview.atunit.*;
* import net.mindview.util.*;
* public class TestNoteEx11 {
...
*	@Test void _methodOne() { 
*		assert methodOne().equals("methodOne"); 
*	} 
*	@TestNote (note = "methodTwo contains a println() statement")
*	@Test void _methodTwo() {
*		assert methodTwo() == 2;
*	}
*	public static void main(String[] args) throws Exception {
*		OSExecute.command(
*			"java net.mindview.atunit.AtUnitEx11 TestNoteEx11");
*	}
* }
* In package new.mindview.atunit:
* //: net/mindview/atunit/TestNote.java
* // The @TestNote tag.
...
*	public String note() default "no note";
* } 
**/
...
public class AtUnitEx11 implements ProcessFiles.Strategy {
