...
public class holding4 {
	public static void printAny(Collection c) { //metodo que admite cualquier coleccion
		Iterator it = c.iterator(); //genero un iterador de esa coleccion
		
		while(it.hasNext()) //mientras haya uno mas lo imprimo
