...
public class FailingConstructor22 {
	Integer[] ia = new Integer[2]; //genero un array de 2 posciones, 0 y 1
	String s;
	FailingConstructor22(String s) throws Exception {
		ia[0] = 0;
		ia[1] = 1;
		ia[2] = 2;//al acceder a la posición 2, el array revienta y manda la excepción
		this.s = s; 
	}
	public static void main(String[] args) {
		try {
			FailingConstructor22 fc = new FailingConstructor22("hi");
		} catch(Exception e) { //capturo la traza
