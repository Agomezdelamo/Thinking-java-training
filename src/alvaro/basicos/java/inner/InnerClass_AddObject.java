...
public class InnerClass_AddObject {
	private Object[] items;//arRay de items que incrementamos con add
	private int next = 0;
	public InnerClass_AddObject (int tamañoArray) { items = new Object[tamañoArray];}
	...
	public static void main (String[] args){
		InnerClass_AddObject outter = new InnerClass_AddObject(10);
		for(int i = 0; i < 10; i++)
		...
		InnerClass_AddObject outter2 = new InnerClass_AddObject(4);
