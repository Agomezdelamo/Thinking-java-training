...
public class PatronAdapter2 extends CaracteresRandom implements Readable {
	
	private int count;
	
	//constructor
	public PatronAdapter2(int count) { this.count = count; }
	...
	public static void main(String[] args) {
		 ...
		 */
		Scanner s = new Scanner(new PatronAdapter2(10)); //PATRON ADAPTADOR CaracteresRandom--->Readable
		while(s.hasNext())
